# this code will give you output in terminal ----------------------
...
## This code will provide you the output in GUI --------------
...
## This is an streamlit app code. 
# please refer for code --> sidStreamlitApp.py 
